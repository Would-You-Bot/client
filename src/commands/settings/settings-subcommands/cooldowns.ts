...
export default async function settingsGeneral(
	...
	const cooldownButtons = new ActionRowBuilder<MessageActionRowComponentBuilder>().addComponents(
		new ButtonBuilder()
	...
	const setDeleteButtons = new ActionRowBuilder<MessageActionRowComponentBuilder>();
