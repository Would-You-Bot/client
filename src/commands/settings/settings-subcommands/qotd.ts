...
export default async function settingsGeneral(
	...
	const dailyButtons1 = new ActionRowBuilder<MessageActionRowComponentBuilder>().addComponents(
		new ButtonBuilder()
			.setCustomId("dailyChannel")
			.setEmoji("1185973667973320775")
			.setLabel(client.translation.get(guildDb?.language, "Settings.button.dailyChannel"))
			.setStyle(guildDb.dailyChannel ? ButtonStyle.Primary : ButtonStyle.Secondary),
		new ButtonBuilder()
			.setCustomId("dailyRole")
			.setEmoji("1185973666811478117")
			.setLabel(client.translation.get(guildDb?.language, "Settings.button.dailyRole"))
			.setStyle(guildDb.dailyRole ? ButtonStyle.Primary : ButtonStyle.Secondary),
		new ButtonBuilder()
	...
	const dailyButtons2 = new ActionRowBuilder<MessageActionRowComponentBuilder>().addComponents(
		new ButtonBuilder()
			.setCustomId("dailyTimezone")
			.setEmoji("1185973663674150912")
			.setLabel(client.translation.get(guildDb?.language, "Settings.button.dailyTimezone"))
			.setStyle(guildDb.dailyTimezone ? ButtonStyle.Success : ButtonStyle.Secondary),
		new ButtonBuilder()
			.setCustomId("dailyInterval")
			.setEmoji("1185973661736374405")
			.setLabel(client.translation.get(guildDb?.language, "Settings.button.dailyInterval"))
			.setStyle(guildDb.dailyInterval ? ButtonStyle.Success : ButtonStyle.Secondary),
		new ButtonBuilder()
			.setCustomId("daySelection")
			.setEmoji("1220826970133368842")
			.setLabel(client.translation.get(guildDb?.language, "Settings.button.daySelect"))
			.setStyle(ButtonStyle.Success),
	);

	// Third button row
	// Deals with toggles
	const dailyButtons3 = new ActionRowBuilder<MessageActionRowComponentBuilder>().addComponents(
		new ButtonBuilder()
		...
		new ButtonBuilder()
			...
			.setLabel(client.translation.get(guildDb?.language, "Settings.button.autoPin"))
			.setStyle(guildDb.autoPin ? ButtonStyle.Success : ButtonStyle.Secondary),
		new ButtonBuilder()
