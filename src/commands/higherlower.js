  ...
  module.exports = {
    ...
    async execute(interaction, client, guildDb) {
      const initembed = new EmbedBuilder()
        .setColor("#0598F6")
        .setTitle(client.translation.get(guildDb?.language, "HigherLower.initial.title"))
        .setDescription(client.translation.get(guildDb?.language, "HigherLower.initial.description"))
        .setFooter({
