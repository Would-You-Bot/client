    ...
    switch (interaction.options.getString('choose')) {
            ...
            .setDescription(
              `${client.translation.get(guildDb.language, 'Settings.embed.welcome')}: ${
                ...
                `${client.translation.get(guildDb.language, 'Settings.embed.welcomePing')}: ${
                  guildDb.welcomePing ? config.emojis.check.full : config.emojis.close.full
                }\n` +
      ...
      default: {
        const errorEmbed = new EmbedBuilder()
          .setTitle(client.translation.get(guildDb.language, 'Settings.embed.errorTitle'))
          .setDescription(client.translation.get(guildDb.language, 'Settings.embed.errorDescription'))
