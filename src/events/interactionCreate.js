module.exports = async (client, interaction) => {
    const restrict = ["dailyChannel", "welcomeChannel", "dailyInterval", "dailyType", "replayCooldown", "voteCooldown", "welcomePing", "welcome", "welcomeChannel", "dailyRole", "dailyTimezone", "dailyMsg"]
