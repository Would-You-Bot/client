...
const button: Button = {
  ...
  execute: async (interaction, client, guildDb) => {
      ...
      fields: [
        {
          customId: "input",
          style: "line",
          label: "What should the image be?",
          required: true,
    ...
    const schema = welcomeEmbed({ guildDb: guildDb, image: value });
