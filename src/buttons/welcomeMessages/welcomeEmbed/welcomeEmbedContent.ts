...
const button: Button = {
  ...
  execute: async (interaction, client, guildDb) => {
      ...
      fields: [
        {
          customId: "input",
          style: "line",
          label: "What should the message content be?",
          required: true,
    ...
    const schema = welcomeEmbed({ guildDb: guildDb, content: value });
    ...
    const welcome = embed({ client: client, guildDb: guildDb, content: value });
