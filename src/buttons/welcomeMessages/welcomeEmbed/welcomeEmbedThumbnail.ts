...
const button: Button = {
  ...
  execute: async (interaction, client, guildDb) => {
      ...
      fields: [
        {
          customId: "input",
          style: "line",
          label: "What should the thumbnail be?",
          required: true,
    ...
    const schema = welcomeEmbed({ guildDb: guildDb, thumbnail: value });
