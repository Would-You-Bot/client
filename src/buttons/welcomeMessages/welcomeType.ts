import { ActionRowBuilder, type MessageActionRowComponentBuilder, StringSelectMenuBuilder } from "discord.js";
...
const button: Button = {
	...
	execute: async (interaction, client, guildDb) => {
		...
		interaction.update({
			embeds: [],
			content: client.translation.get(guildDb?.language, "Settings.welcomeType"),
			components: [inter],
			options: {
				ephemeral: true,
			},
